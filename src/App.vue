...
const VIEW_IMPORTERS: Record<string, () => Promise<{ default: Component }>> = {
  ...
  // 慢病（五高）管理域
  'chronic-dashboard': () => import('./components/ChronicDashboardView.vue'),
  ...
  'dietitian-activity-config': () => import('./components/DietitianActivityConfigView.vue'),
};
...
const ROLE_TABS: Record<string, string[]> = {
  ...
  dietitian: ['dietitian-dashboard', 'dietitian-unannotated-list', 'dietitian-config', 'dietitian-student-detail', 'account-manage', 'doctor-interpretation', 'doctor-consult', 'ops-content', 'ops-content-new', 'article-detail', 'dietitian-chronic-alerts', 'report-transcribe', 'dietitian-activity-config'],
